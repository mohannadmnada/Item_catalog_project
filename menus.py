...
# Create dummy user
User1 = User(name="admin", email="mohannadmnada@gmail.com")
session.add(User1)
session.commit()
...
menuItem1 = MenuItem(name="Dolma",
                     ...
                     price="$9.99", restaurant=restaurant1, user_id=1)
...
menuItem3 = MenuItem(name="Noodles",
                     description="Asian noodles"
                     "spicy or rigular noodles.",
                     price="$2.00", restaurant=restaurant1, user_id=1)
...
# Menu for Nada
restaurant2 = Restaurant(name="Nada")

session.add(restaurant2)
session.commit()


menuItem1 = MenuItem(name="Biryani",
                     description="Rice dish layered with chicken.",
                     price="$7.99", restaurant=restaurant2)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(name="casarol",
                     description="vegetables with meat"
                     "lvegetales in red sous and meat.",
                     price="$25",  restaurant=restaurant2)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(name="Veg Biryani",
